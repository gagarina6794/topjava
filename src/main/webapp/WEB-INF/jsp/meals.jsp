...
<div class="jumbotron pt-4">
    <div class="container">
        ...
        <h3><strong><spring:message code="meal.title"/></strong></h3>
        <hr>

        <div class="row">
            <div class="col-7">
                <div class="card">
                    <div class="card-header"><h5>Фильтрация по дате/времени</h5></div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control col-7" type="date" name="startDate" id="startDate" value="${param.startDate}">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control col-5" type="time" name="startTime" id="startTime" value="${param.startTime}">

                                        <label class="col-form-label" for="endTime"><spring:message code="meal.endTime"/>:</label>
                                        <input class="form-control col-5" type="time" name="endTime" id="endTime" value="${param.endTime}">
                                    </div>
                                </div>
                            </div>
                        </form>
        ...
        <hr>
        <button class="btn btn-primary my-3" onclick="add()">
