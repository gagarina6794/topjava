...
public class MealServiceTest {
    ...
    public void create() {
        ...
        assertMatchMeal(service.getAll(USER_ID), USER_MEAL_3, USER_MEAL_2, USER_MEAL_1, newMeal);
    }

    @Test
    public void delete() {
        service.delete(ADMIN_MEAL_ID_1, ADMIN_ID);
        assertMatchMeal(service.getAll(ADMIN_ID), ADMIN_MEAL_3, ADMIN_MEAL_2);
    }
    ...
    public void getBetweenDates() {
        ...
        assertMatchMeal(all, USER_MEAL_3, USER_MEAL_2);
    }
    ...
    public void getBetweenDateTimes() {
        ...
        assertMatchMeal(all, USER_MEAL_2, USER_MEAL_1);
    }
    ...
    public void update() {
        ...
        assertMatchMeal(service.get(USER_MEAL_ID_1, USER_ID), updated);
    }
    ...
    public void getAll() {
        ...
        assertMatchMeal(all, USER_MEAL_3, USER_MEAL_2, USER_MEAL_1);
    }
}