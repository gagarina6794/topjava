...
public class MealTestData {
    ...
    public static final Meal ADMIN_MEAL3 = new Meal(ADMIN_MEAL_ID + 2, of(2015, Month.MAY, 30, 13, 0), "Админ обед", 1000);
    public static final Meal ADMIN_MEAL4 = new Meal(ADMIN_MEAL_ID + 3, of(2015, Month.MAY, 30, 20, 0), "Админ ужин", 500);
